...
[![Get it on Google Play](/images/icon-google-play.png)](https://play.google.com/store/apps/details?id=com.cspnwallet)

### bitcoin done right

This is the Android port of the breadwallet iOS app, which can be found [here](https://github.com/cspnwallet/breadwallet/).
...
4. Go to https://github.com/cspnwallet/breadwallet-android and clone or download the project
