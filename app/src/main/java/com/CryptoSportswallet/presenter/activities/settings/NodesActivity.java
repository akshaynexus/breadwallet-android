...
//    private TextView nodeLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BRSharedPrefs.putCurrentWalletIso(this, "CSPN");
        ...
        switchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletCryptoSportsManager wm = WalletCryptoSportsManager.getInstance(NodesActivity.this);
    ...
    private void updateButtonText() {
        WalletCryptoSportsManager wm = WalletCryptoSportsManager.getInstance(this);
    ...
    private void createDialog() {
        ...
        mDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletCryptoSportsManager wm = WalletCryptoSportsManager.getInstance(app);
