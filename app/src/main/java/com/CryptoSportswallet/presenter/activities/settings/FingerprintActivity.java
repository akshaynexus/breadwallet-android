...
public class FingerprintActivity extends BRActivity {
    ...
    private String getLimitText() {
        ...
        return String.format(getString(R.string.TouchIdSettings_spendingLimit), CurrencyUtils.getFormattedAmount(this, "CSPN", amount,8), CurrencyUtils.getFormattedAmount(this, iso, curAmount,8));
    }
