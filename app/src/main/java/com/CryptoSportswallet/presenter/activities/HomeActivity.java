...
import com.CryptoSportswallet.presenter.activities.settings.SecurityCenterActivity;
import com.CryptoSportswallet.presenter.activities.settings.SettingsActivity;
...
import com.CryptoSportswallet.tools.adapter.WalletListAdapter;
...
import com.CryptoSportswallet.tools.manager.PromptManager;
...
public class HomeActivity extends BRActivity implements InternetManager.ConnectionReceiverListener, SyncManager.OnProgressUpdate {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mFiatTotal.setTextColor(R.color.black);
        mFiatTotaltext= findViewById(R.id.total_assets_label);
        mFiatTotaltext.setTextColor(R.color.black);
        mSideLogo = findViewById(R.id.sidelogo);
        mSideLogo.setScaleType(ImageView.ScaleType.FIT_START);
//        if(isNetworkAvailable()){
//            Picasso.get().load("https://CryptoSports.tech/resources/logo-color-main-600×198.png").into(mSideLogo);
//
//        }
//        else{
            Picasso.get().load(R.drawable.cspninline).into(mSideLogo);
...
//            Log.d(TAG, "showNextPrompt: " + toShow);
    ...
    private void updateUi() {
        ...
        mFiatTotal.setText(CurrencyUtils.getFormattedAmount(this, BRSharedPrefs.getPreferredFiatIso(this), fiatTotalAmount,8));
