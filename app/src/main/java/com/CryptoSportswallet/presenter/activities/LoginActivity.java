...
import static com.CryptoSportswallet.R.color.almost_black;
import static com.CryptoSportswallet.R.color.white;
import static com.CryptoSportswallet.tools.util.BRConstants.PLATFORM_ON;
import static com.CryptoSportswallet.tools.util.BRConstants.SCANNER_REQUEST;
...
public class LoginActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enterPinLabel.setTextColor(R.color.black);
...
//                            AuthManager.getInstance().authSuccess(LoginActivity.this);
        ...
        CryptoSportsApp.addOnBackgroundedListener(new CryptoSportsApp.OnAppBackgrounded() {
            @Override
    ...
    private void unlockWallet() {
        ...
        unlockedText.setTextColor(almost_black);
    ...
    private void setUpOfflineButtons() {
        int activeColor = getColor(almost_black);
