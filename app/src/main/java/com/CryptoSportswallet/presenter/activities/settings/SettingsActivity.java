package com.CryptoSportswallet.presenter.activities.settings;
...
import com.CryptoSportswallet.presenter.activities.CurrencySettingsActivity;
import com.CryptoSportswallet.presenter.activities.UpdatePinActivity;
import com.CryptoSportswallet.presenter.activities.util.BRActivity;
import com.CryptoSportswallet.presenter.entities.BRSettingsItem;
...
import static com.CryptoSportswallet.R.layout.settings_list_item;
import static com.CryptoSportswallet.R.layout.settings_list_section;
...
*/
        items.add(new BRSettingsItem(getString(R.string.Settings_CryptoSports), "", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SettingsActivity.this, CurrencySettingsActivity.class);
                BRSharedPrefs.putCurrentWalletIso(app, "CSPN");//change the current wallet to the one they enter settings to
                startActivity(intent);
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));
        ...
        items.add(new BRSettingsItem(getString(R.string.Settings_review), "", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent appStoreIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + "com.CryptoSportswallet"));
                    appStoreIntent.setPackage("com.android.vending");

                    startActivity(appStoreIntent);
                } catch (android.content.ActivityNotFoundException exception) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + "com.CryptoSportswallet")));
                }
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));
