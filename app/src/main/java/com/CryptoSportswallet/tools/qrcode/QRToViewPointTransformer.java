package com.CryptoSportswallet.tools.qrcode;
...
public class QRToViewPointTransformer {
  ...
  public PointF[] transform(ResultPoint[] qrPoints, boolean isMirrorPreview,
                            QRCodeReaderView.Orientation orientation,
  ...
  public PointF transform(ResultPoint qrPoint, boolean isMirrorPreview, QRCodeReaderView.Orientation orientation,
                          Point viewSize, Point cameraPreviewSize) {
    ...
    if (orientation == QRCodeReaderView.Orientation.PORTRAIT) {
    ...
    } else if (orientation == QRCodeReaderView.Orientation.LANDSCAPE) {
