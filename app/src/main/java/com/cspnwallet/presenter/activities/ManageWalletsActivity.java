...
import com.cspnwallet.tools.adapter.ManageTokenListAdapter;
import com.cspnwallet.tools.animation.SimpleItemTouchHelperCallback;
    ...
    protected void onResume() {
        ...
        for (int i = 0; i < mTokens.size(); i++) {
            ...
            if (!tokenSymbol.equalsIgnoreCase("btc") && !tokenSymbol.equalsIgnoreCase("bch") &&
                ...
                tokenItem = new TokenItem(null, "CSPN", "Crypto Sports", null);

//            else if (tokenSymbol.equalsIgnoreCase("bch"))
//                tokenItem = new TokenItem(null, "BCH", "Crypto Sports Cash", null);
