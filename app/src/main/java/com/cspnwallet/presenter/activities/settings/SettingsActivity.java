...
public class SettingsActivity extends BaseSettingsActivity {
    ...
    public static final String EXTRA_MODE = "com.cspnwallet.presenter.activities.settings.EXTRA_MODE";
    public static final String MODE_SETTINGS = "settings";
    public static final String MODE_PREFERENCES = "preferences";
    private RelativeLayout mMenulayoutsetting;
