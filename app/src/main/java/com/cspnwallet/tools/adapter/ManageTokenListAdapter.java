package com.cspnwallet.tools.adapter;
...
import com.cspnwallet.presenter.activities.AddWalletsActivity;
import com.cspnwallet.presenter.customviews.BaseTextView;
import com.cspnwallet.presenter.entities.TokenItem;
import com.cspnwallet.tools.animation.ItemTouchHelperAdapter;
import com.cspnwallet.tools.animation.ItemTouchHelperViewHolder;
import com.cspnwallet.tools.listeners.OnStartDragListener;
...
public class ManageTokenListAdapter extends RecyclerView.Adapter<ManageTokenListAdapter.ManageTokenItemViewHolder> implements ItemTouchHelperAdapter {
    ...
    public void onBindViewHolder(@NonNull final ManageTokenListAdapter.ManageTokenItemViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == VIEW_TYPE_WALLET) {
            ...
            if (holder instanceof AddWalletItemViewHolder && BRConstants.allowOthercoins) {
