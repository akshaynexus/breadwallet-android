package com.cspnwallet.platform.pricealert
...
import com.cspnwallet.model.PriceAlert
import com.cspnwallet.presenter.entities.CurrencyEntity
import com.cspnwallet.repository.*
...
class PriceAlertWorkerTest {
    ...
    fun testTogglesHasBeenTriggeredWhenTriggered() {
        putAlerts(PriceAlert.priceTargetIncrease("CSPN", 100f, "USD"))
        putRates(CurrencyEntity("USD", "Dollar", 101f, "CSPN"))
    ...
    fun testDoesNotToggleHasBeenTriggeredWhenNotTriggered() {
        putAlerts(PriceAlert.priceTargetIncrease("CSPN", 100f, "USD"))
        putRates(CurrencyEntity("USD", "Dollar", 100f, "CSPN"))
    ...
    fun testTogglesHasBeenTriggeredWhenTriggerUnmet() {
        putAlerts(PriceAlert.priceTargetIncrease("CSPN", 100f, "USD"))
        putRates(CurrencyEntity("USD", "Dollar", 99f, "CSPN"))
    ...
    fun testUpdatesPinnedPriceWhenTriggered() {
        putAlerts(PriceAlert.percentageChanged("CSPN", 10f, "USD", 100f))
        putRates(CurrencyEntity("USD", "Dollar", 90f, "CSPN"))
    ...
    fun testUpdatesStartTimeWhenOutOfWindow() {
        ...
        putAlerts(PriceAlert.percentageDecreasedInDay("CSPN", 10f, "USD", now, 100f))
        putRates(CurrencyEntity("USD", "Dollar", 100f, "CSPN"))
    ...
    fun testDoesNotUpdateStartTimeWhenInWindow() {
        ...
        putAlerts(PriceAlert.percentageDecreasedInDayAndWeek("CSPN", 10f, "USD", now, 100f))
        putRates(CurrencyEntity("USD", "Dollar", 100f, "CSPN"))
